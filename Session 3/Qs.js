...
//IV. Create a function that will take a array with size of 300 as input 
// and return 300 dom elements each of which has the string as its content 
// and then append them into the "body" so that you can see them on your screen. 
// Style your list with css (you need to do the research youself on this part) 
// to look like the design i attached in this session. 
